 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LAlt | LCTR | LGUI |LOWER | / Enter /       \Space \  |RAISE | RGUI | RCTR | RAlt |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     KC_SPOT,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
...
[_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      KC_SPOT,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
                 KC_LALT, KC_LCTRL,KC_LGUI, KC_LOWER, KC_ENT,      KC_SPC,  KC_RAISE, KC_RGUI, KC_RCTRL, KC_RALT  \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT( \
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGUP, KC_PRVSCR,   KC_UP, KC_NXTSCR,KC_DLINE, KC_BSPC, \
 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|                   |--------+-------+--------+--------+--------+---------| 
  RGB_TOG, RGB_HUI,RGB_SAI, RGB_VAI, XXXXXXX,KC_COLEMAK,                 C(G(KC_LEFT)),KC_NO,KC_NO,C(G(KC_RGHT)),XXXXXXX, XXXXXXX, \
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------| 
